...
HOROSCOPE_TEASER_DAILY_DAYS = int(os.environ.get('HOROSCOPE_TEASER_DAILY_DAYS', '5'))
HOROSCOPE_PERIODIC_TEASER_INTERVAL_DAYS = int(os.environ.get('HOROSCOPE_PERIODIC_TEASER_INTERVAL_DAYS', '5'))
