...
- [x] Add tests for horoscope/handlers/subscription.py (pre_checkout_handler, successful_payment happy path)
- [x] Add tests for horoscope/handlers/utils.py (aget_user_language)
- [x] Add tests for telegram_bot/handlers/errors.py (error_handler)
- [x] Add tests for telegram_bot/handlers/start.py (start_handler)
